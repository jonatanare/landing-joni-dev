...
export default function About () {
  return (
    <div className='flex flex-col'>
      <div className='order-2 mt-10 w-full columns-auto md:columns-6'>

        {
            services.map((service, index) => (
                <div key={index} className='flex items-center p-5 shadow-lg rounded-lg w-full mb-6 dark:bg-teal-800'>
                    <div>
      ...
      <div className='order-1 w-full columns-auto md:columns-6'>
        <h2 className='text-5xl font-bold text-black pt-9 dark:text-white'>What do I help?</h2>
        <p className='text-lg mt-3 text-gray-600 dark:text-white'>I will hel you with finging a solution and solve
          your problems. We use process design to create digital products. Besids that also help their business
        </p>
        <p className='text-lg text-gray-600 dark:text-white'>We use process design to create digital products. Besids that also help their business</p>
